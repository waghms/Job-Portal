...
<head>
	...
	<title>Job Portal Show Questions Details</title>
			...
			<div class="container">
				<div class="page-inner">
					<div class="page-header">
						<h3 class="fw-bold mb-3">Question Details</h3>
								...
								<div class="card-body">
									<div class="row">
										...
										<div class="col-md-12">
											...
											<div class="row mb-2">
												<div class="col-md-4"><strong>Question Type:</strong></div>
												<div class="col-md-8">{{ $question->type }}</div>
											</div>
											
											<div class="row mb-2">
												<div class="col-md-4"><strong>Option A:</strong></div>
												<div class="col-md-8">{{ $question->option_a }}</div>
											</div>
											
											<div class="row mb-2">
												<div class="col-md-4"><strong>Option B:</strong></div>
												<div class="col-md-8">{{ $question->option_b }}</div>
											</div>
											
											<div class="row mb-2">
												<div class="col-md-4"><strong>Option C:</strong></div>
												<div class="col-md-8">{{ $question->option_c }}</div>
											</div>
											
											<div class="row mb-2">
												<div class="col-md-4"><strong>Option D:</strong></div>
												<div class="col-md-8">{{ $question->option_d }} </div>
											</div>

                                            <div class="row mb-2">
												<div class="col-md-4"><strong>Correct Answer:</strong></div>
												<div class="col-md-8">{{ $question->correct_answer }} </div>
											</div>
										</div>
									</div>
									...
									<!-- Back Button -->
									<div class="mt-3">
										<a href="{{ route('admin.questions.index') }}" class="btn btn-secondary">Back to Questions</a>
									</div>
								</div>
							</div>
						</div>
