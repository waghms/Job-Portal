...
<head>
	...
	<title>Job Portal Update Questions</title>
                        ...
                        <li class="nav-item active submenu">
							...
							<div class="collapse show" id="sidebarLayouts">
								<ul class="nav nav-collapse">
                                    ...
                                    <li class="active">
										<a href="#">
											<span class="sub-item">Edit Question</span>
										</a>
									</li>
								</ul>
							</div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="type" id="type" class="form-control" required>
                                                        <option value="Reasoning" {{ old('type', $question->type) == 'Reasoning' ? 'selected' : '' }}>Reasoning</option>
                                                        <option value="Logical" {{ old('type', $question->type) == 'Logical' ? 'selected' : '' }}>Logical</option>
                                                        <option value="Quantitative" {{ old('type', $question->type) == 'Quantitative' ? 'selected' : '' }}>Quantitative</option>
                                                        <option value="Verbal" {{ old('type', $question->type) == 'Verbal' ? 'selected' : '' }}>Verbal</option>
                                                        <option value="Data Interpretation" {{ old('type', $question->type) == 'Data Interpretation' ? 'selected' : '' }}>Data Interpretation</option>
                                                    </select>
                                                </div>
                                            </div>
