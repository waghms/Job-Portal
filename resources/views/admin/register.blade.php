...
<head>
    <meta charset="utf-8">
    <title>Job Portal Admin Sign Up</title>
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <a href="{{ route('admin.login') }}" class="nav-item nav-link">Sign In</a>
                        ...
                        <form method="POST" action="{{ route('admin.register.submit') }}">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12" data-wow-delay="0.3s">
                                    <h5>Already have an account? <a href="{{ route('admin.login') }}">Sign In Here</a></h5>
                                    <p>If you already have an account, you can sign in to manage your jobs and users.</p>
                                </div>
                            </div>
                        </form>
                    </div>
