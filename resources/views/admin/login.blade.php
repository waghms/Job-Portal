...
<head>
    <meta charset="utf-8">
    <title>Job Portal Admin Sign In</title>
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <a href="{{ route('admin.login') }}" class="nav-item nav-link @if(request()->routeIs('admin.login')) active @endif">Sign In</a>
                    <a href="{{ route('admin.register') }}" class="nav-item nav-link">Sign Up</a>
                </div>
                <a href="{{ route('user.login') }}" class="btn btn-primary rounded-0 py-4 px-lg-4 d-none d-lg-block">Apply A Job<i class="fa fa-arrow-right ms-3"></i></a>
            </div>
        </nav>
        <!-- Navbar End -->
                        ...
                        <form method="POST" action="{{ route('admin.login.submit') }}">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12" data-wow-delay="0.3s">
                                    <h5>New admin? <a href="{{ route('admin.register') }}">Sign Up Here</a></h5>
                                    <p>If you don't have an account, you can create one here. Register for free and start managing the portal!</p>
                                </div>
                            </div>
                        </form>
                    </div>
