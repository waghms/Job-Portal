...
<head>
	...
	<title>Job Portal Jobs list</title>
			...
			<div class="container">
				<div class="page-inner">
					<div class="page-header">
						<h3 class="fw-bold mb-3">All Jobs</h3>
								...
								<form method="GET" action="{{ route('admin.jobs.index') }}" class="mb-4">
									<div class="row">
										...
										<div class="col-12 col-md-12 col-lg-3 d-flex justify-content-end mt-3 mt-md-0">
											<a href="{{ route('admin.jobs.create') }}" class="btn btn-primary w-100">Add</a>
										</div>
									</div>
								</form>
									...
									<table class="table table-striped table-bordered table-hover">
										...
										<tbody>
											@foreach ($jobs as $index => $job)
												<tr>
													<td>{{ ($jobs->currentPage() - 1) * $jobs->perPage() + $index + 1 }}</td> <!-- Adjusted SR -->
													<td>{{ $job->job_id }}</td>
													<td>{{ $job->postname }}</td>
													<td>{{ $job->location }}</td>
													<td>{{ $job->salary }}</td>
													...
													<td>
														<!-- View Button -->
														<a href="{{ route('admin.jobs.show', $job->id) }}" class="btn btn-info btn-sm">View</a>
