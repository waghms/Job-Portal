...
<head>
	...
	<title>Job Portal Add New Jobs</title>
			...
			<div class="container">
				<div class="page-inner">
					<div class="page-header">
						<h3 class="fw-bold mb-3">Add Jobs</h3>
								...
								<div class="card-body">
									...
									<form action="{{ route('admin.jobs.store') }}" method="POST" enctype="multipart/form-data">
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" name="job_id" id="job_id" class="form-control" required>
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" name="postname" id="postname" class="form-control" required>
												</div>
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<option value="Diploma">Diploma (Technical/Professional)</option>
													<option value="Graduation">Graduation (Bachelors Degree)</option>
													<option value="Post Graduation">Post Graduation (Masters Degree)</option>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label for="logo">Vacancy:</label>
													<input type="vacancy" name="vacancy" id="vacancy" class="form-control">
												</div>
											</div>
										</div>
