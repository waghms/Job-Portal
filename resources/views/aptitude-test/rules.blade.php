...
<head>
    <meta charset="utf-8">
    <title>Job Portal Aptitude Test Rules</title>
    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5 bg-dark page-header mb-5">
            <div class="container my-5 pt-5 pb-4">
                <h1 class="display-3 text-white mb-3 animated slideInDown">Aptitude Test Rules</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb text-uppercase">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Pages</a></li>
                        <li class="breadcrumb-item text-white active" aria-current="page">Aptitude Test Rules</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container">
            <h2>Aptitude Test Rules</h2>
            <ul>
                <li>Each question carries 5 marks.</li> 
                <li>You will have 20 questions in total.</li>
                <li>Late submissions will not be accepted.</li>
                <li>You will have 20 minutes to complete the test.</li> 
                <li>If a question is left unanswered, no marks will be awarded.</li>
                <li>Once the time is up or you submit the test, your answers will be final.</li>
                <li>The test consists of the following sections:</li>
                <ul>
                    <li>Reasoning</li>
                    <li>Logical</li>
                    <li>Quantitative</li>
            ...
            <a href="{{ route('user.aptitude.test.start', ['job_id' => $job_id]) }}" class="btn btn-primary">Start Test</a>
        </div>
