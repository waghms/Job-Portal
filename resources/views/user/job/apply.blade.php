...
<head>
    <meta charset="utf-8">
    <title>Job Portal Apply for Job</title>
...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5 bg-dark page-header mb-5">
            ...
            <h1 class="display-3 text-white mb-3 animated slideInDown">Apply for {{ $job->company_name }} - {{ $job->postname }}</h1>
            </div>
            ...
            @if(session('error'))
            <div class="d-flex justify-content-center">
                    <div class="btn btn-danger w-50 mt-3 text-center">
                        {{ session('error') }}
                    </div>
                </div>
            @endif
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="row g-4 justify-content-center">
                    <div class="col-md-8">
                    <form action="{{ route('user.job.submitApplication', ['job_id' => $job->id, 'id' => $profile->id]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('jobroll') is-invalid @enderror" name="jobroll" value="{{ old('jobroll') }}" required>
                                    @error('jobroll')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>
                                </div>
