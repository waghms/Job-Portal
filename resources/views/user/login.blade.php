...
<head>
    <meta charset="utf-8">
    <title>Job Portal User Sign In</title>
                        ...
                        <form method="POST" action="{{ route('user.login.submit') }}">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12" data-wow-delay="0.3s">
                                    <h5>New user? <a href="{{ route('user.register') }}">Sign Up Here</a></h5>
                                    <p>If you don't have an account, you can create one here. Register for free and start applying for jobs!</p>
                                </div>
                            </div>
                        </form>
                    </div>
