...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5 bg-dark page-header mb-5">
            ...
            <h1 class="display-3 text-white mb-3 animated slideInDown">Create Profile</h1>
            </div>
            @if(session('message'))
                    ...
                    <div class="col-md-8">
                        <form action="{{ route('user.profile.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('district') is-invalid @enderror" name="district" value="{{ old('district') }}" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('pancard_no') is-invalid @enderror" name="pancard_no" value="{{ old('pancard_no') }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('ssc_highschool_name') is-invalid @enderror" name="ssc_highschool_name" value="{{ old('ssc_highschool_name') }}" required>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('ssc_percentage') is-invalid @enderror" name="ssc_percentage" value="{{ old('ssc_percentage') }}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('ssc_passout_year') is-invalid @enderror" name="ssc_passout_year" value="{{ old('ssc_passout_year') }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('hsc_college_name') is-invalid @enderror" name="hsc_college_name" value="{{ old('hsc_college_name') }}" required>
                                @error('hsc_college_name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('hsc_percentage') is-invalid @enderror" name="hsc_percentage" value="{{ old('hsc_percentage') }}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('hsc_passout_year') is-invalid @enderror" name="hsc_passout_year" value="{{ old('hsc_passout_year') }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('graduation_college_name') is-invalid @enderror" name="graduation_college_name" value="{{ old('graduation_college_name') }}" required>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('graduation_percentage') is-invalid @enderror" name="graduation_percentage" value="{{ old('graduation_percentage') }}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('graduation_passout_year') is-invalid @enderror" name="graduation_passout_year" value="{{ old('graduation_passout_year') }}" required>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('postname') is-invalid @enderror" name="postname" value="{{ old('postname') }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('skills') is-invalid @enderror" name="skills" required>{{ old('skills') }}</textarea>
